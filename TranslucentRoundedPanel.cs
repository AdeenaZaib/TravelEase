...
{
    public class TranslucentRoundedPanel : Panel
    {
        ...
        public TranslucentRoundedPanel()
        {
            DoubleBuffered = true;
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            // Shadow effect: draw shadow behind the panel
            using (Brush shadowBrush = new SolidBrush(Color.FromArgb(80, Color.Black)))  // Dark shadow with some transparency
            {
